                    ...
                    <tr>
                        <td>
                            ...
                            <div id="ctl00_cphContentsArea_UpdatePanel1">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="search" name="txtShiftPtnName" tabindex="2"
                                                    value="<?php echo e(old('txtShiftPtnName') ?? $shiftptn_data->SHIFTPTN_NAME); ?>"
                                                    ...
                                                    <?php if(isset($shiftptn_data->SHIFTPTN_NAME)): ?>
                                                    autofocus
                                                    onFocus="this.select()"
                                                    <?php endif; ?>>
                                        ...
                                        <div>
                                            <table tabindex="4" class="GridViewPadding GridViewBorder"
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php $__currentLoopData = $shiftptn_select; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $shiftptn): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr class="rowGvShiftPtn" style="pointer-events:disabled">
                                                        <td align="center">
                                                            <span id="lblDayNo<?php echo e($key); ?>" class="lblDayNo"><?php echo e($shiftptn->DAY_NO); ?>日目</span>
                                                        </td>
                                                        <td>
                                                            <select name="ddlWorkPtn[<?php echo e($key); ?>][workPtn]"
                                                            id="ddlWorkPtn<?php echo e($key); ?>workPtn" tabindex="5"
                                                            class="ddlWorkPtn coloredSelect" style="width: 260px;">
                                                            <option style=color:black; value="" ></option>
                                                            <?php $__currentLoopData = $workptn_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $workptn_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($workptn_data->WORKPTN_CD); ?>"
                                                                <?php echo e($workptn_data->WORK_CLS_CD == '00' ? 'style=color:red;' : 'style=color:black;'); ?>

                                                                <?php echo e($workptn_data->WORKPTN_CD == (old('ddlWorkPtn',$shiftptn->WORKPTN_CD)) ? 'selected' : ''); ?>>
                                                                <?php echo e($workptn_data->WORKPTN_NAME); ?>

                                                            </option>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </select>
                                                            <br>
                                                            <span class="text-danger" id="shiftPtn<?php echo e($key); ?>workPtn"></span>
                                                        </td>
                                                        <td align="center">
                                                            <input name="dltBtn[<?php echo e($key); ?>][btnDelete]" class="ButtonStyle1 deleteButtonRow"
                                ...
                                <input type="hidden" name="hideShiftPtnCd" id="hideShiftPtnCd" value="<?php echo e($shiftptn_data->SHIFTPTN_CD); ?>">
                                ...
                                <p class="ButtonField1">
                                    <input type="button" value="更新" name="btnUpdate" tabindex="6" id="btnUpdate"
                                                ...
                                                data-url="<?php echo e(url('shift/MT04ShiftPtnUpdate')); ?>">
                                    ...
                                    <input type="button" value="削除" name="btnDelete" tabindex="8" id="btnDelete"
                                                ...
                                                disabled
                                                <?php else: ?>
                                                data-url="<?php echo e(url('shift/MT04ShiftPtnDelete')); ?>"
                                                <?php endif; ?>>
                                </p>
    ...
    $(document).on('click', '.update', function() {
        ...
        .done((data, textStatus, jqXHR) => {
            if ($('#hideShiftPtnCd').val() == '') {
                ...
                location.href='<?php echo e(url('shift/MT04ShiftPtnReference')); ?>';
            }
        })
...
function appendRow() {
    ...
    selectSystem.innerHTML =    '<select name="ddlWorkPtn[' + (count - 1) + '][workPtn]" id="ddlWorkPtn' + (count - 1) + 'workPtn"'
                                ...
                                + '<option value="<?php echo e($workptn_data->WORKPTN_CD); ?>"'
                                   + '<?php echo e($workptn_data->WORK_CLS_CD == '00' ? 'style=color:red;' : 'style=color:black;'); ?>'
                                   + '<?php echo e($workptn_data->WORKPTN_CD == old('ddlWorkPtn') ? 'selected' : ''); ?>>'
                                   + '<?php echo e($workptn_data->WORKPTN_NAME); ?>'
                                + '</option>'
                                + '<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>'
                                + '</select>'
...
<?php echo $__env->make('menu.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/shift/MT04ShiftPtnEditor.blade.php ENDPATH**/ ?>