        ...
        <table class="workTable" style="width: 100%;">
            <thead>
                <tr class="table-head1" style="width: 100%;">
                    ...
                    <th colspan="1" style="width: 35px;">出勤:<?php echo e($wt_data->SUM_WORKDAY_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">有休:<?php echo e($wt_data->SUM_PADHOL_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">代休:<?php echo e($wt_data->SUM_COMPDAY_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">特休:<?php echo e($wt_data->SUM_SPCHOL_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">休出:<?php echo e($wt_data->SUM_HOLWORK_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">欠勤:<?php echo e($wt_data->SUM_ABCWORK_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">遅刻:<?php echo e($wt_data->SUM_TARD_CNT); ?></th>
                    <th colspan="1" style="width: 35px;">早退:<?php echo e($wt_data->SUM_LEAVE_CNT); ?></th>
                    <th colspan="6"></th>
                </tr>
