...
<?php $__env->startSection('title', '端数処理情報入力'); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="WORKPTN_CD" tabindex="1" autofocus
                                                    id="WORKPTN_CD" style="width: 250px;" <?php if(isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>
                                                    ...
                                                    <option value="<?php echo e($workptn_name->WORKPTN_CD); ?>" class ="view" data-url="<?php echo e(url('master/MT07FractionEditor')); ?>"
                                                        <?php echo e($workptn_name->WORK_CLS_CD == '00' ? 'style=color:red;' : 'style=color:black;'); ?>

                                                        <?php echo e($workptn_name->WORKPTN_CD == (old('WORKPTN_CD', isset($workptn_cd) ? $workptn_cd : '' )) ? 'selected' : ''); ?>>
                                                        <?php echo e($workptn_name->WORKPTN_NAME); ?>

                                                    </option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                                <?php if(isset($workptn_cd)): ?>
                                                <input type="hidden" name="WORKPTN_CD_HIDE" value="<?php echo e($workptn_cd); ?>">
                                                <?php endif; ?>
                                            </td>
                                        </tr>
                                    </tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <input name="FRACTION_CLS_CD" tabindex="2"
                                                    ...
                                                    value="00"
                                                    <?php echo e(old('FRACTION_CLS_CD',isset($search_fraction_data) ? $search_fraction_data->FRACTION_CLS_CD : '') == '00' ? 'checked': ''); ?>

                                                    <?php if(empty($search_fraction_data->FRACTION_CLS_CD)): ?>
                                                    checked
                                                    <?php endif; ?>
                                                    <?php if(!isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>>
                                                    <label for="rbFractionClsHr">時間</label>
                                                <input name="FRACTION_CLS_CD" tabindex="3"
                                                    id="rbFractionClsTm"
                                                    type="radio" value="01"
                                                    <?php echo e(old('FRACTION_CLS_CD',isset($search_fraction_data) ? $search_fraction_data->FRACTION_CLS_CD : '') == '01' ? 'checked': ''); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="WTHR_UNDER_MI" tabindex="4" class="thr"
                                                    ...
                                                    <?php if(!isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>>
                                                    <option value=""></option>
                                                    <?php $__currentLoopData = $cls_detail_mins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls_detail_min): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->WTHR_UNDER_MI == (old('WTHR_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>

                                                        <?php endif; ?>>
                                                        <?php echo e($cls_detail_min->CLS_DETAIL_NAME); ?>
                                            ...
                                            <td>
                                                <select name="WTHR_FRC_CLS_CD" tabindex="5" class="thr"
                                                    ...
                                                    <?php if(!isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>>
                                                    <option value=""></option>
                                                    <?php $__currentLoopData = $cls_detail_rfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls_detail_rf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->WTHR_FRC_CLS_CD == (old('WTHR_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>

                                                        <?php endif; ?>>
                                                        <?php echo e($cls_detail_rf->CLS_DETAIL_NAME); ?>
                                            ...
                                            <td>
                                                <select name="WTTM_UNDER_MI" tabindex="12" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->WTTM_UNDER_MI == (old('WTTM_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="WTTM_FRC_CLS_CD" tabindex="13" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->WTTM_FRC_CLS_CD == (old('WTTM_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="LTHR_UNDER_MI" tabindex="6" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->LTHR_UNDER_MI == (old('LTHR_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="LTHR_FRC_CLS_CD" tabindex="7" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->LTHR_FRC_CLS_CD == (old('LTHR_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="LVTM_UNDER_MI" tabindex="14" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->LVTM_UNDER_MI == (old('LVTM_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="LVTM_FRC_CLS_CD" tabindex="15" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->LVTM_FRC_CLS_CD == (old('LVTM_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="ERHR_UNDER_MI" tabindex="8" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->ERHR_UNDER_MI == (old('ERHR_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="ERHR_FRC_CLS_CD" tabindex="9" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->ERHR_FRC_CLS_CD == (old('ERHR_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OTTM_UNDER_MI" tabindex="16"class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OTTM_UNDER_MI == (old('OTTM_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OTTM_FRC_CLS_CD" tabindex="17" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OTTM_FRC_CLS_CD == (old('OTTM_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <select name="OTHR_UNDER_MI" tabindex="10" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OTHR_UNDER_MI == (old('OTHR_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OTHR_FRC_CLS_CD" tabindex="11" class="thr"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OTHR_FRC_CLS_CD == (old('OTHR_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="RETM_UNDER_MI" tabindex="18" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->RETM_UNDER_MI == (old('RETM_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="RETM_FRC_CLS_CD" tabindex="19" class="ttm"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->RETM_FRC_CLS_CD == (old('RETM_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM1_CD" tabindex="20" class="ovtCD"
                                                    ...
                                                    <?php if(!isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>>
                                                    <option value=""></option>
                                                    <?php $__currentLoopData = $ovt_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ovt_cd): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM1_CD == (old('OVTM1_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>

                                                        <?php endif; ?>>
                                                        <?php echo e($ovt_cd->WORK_DESC_NAME); ?>
                                            ...
                                            <td>
                                                <select name="OVTM1_UNDER_MI" tabindex="21" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM1_UNDER_MI == (old('OVTM1_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM1_FRC_CLS_CD" tabindex="22" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM1_FRC_CLS_CD == (old('OVTM1_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM2_CD" tabindex="23" class="ovtCD"
                                                    ...
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM2_CD == (old('OVTM2_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM2_UNDER_MI" tabindex="24" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM2_UNDER_MI == (old('OVTM2_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM2_FRC_CLS_CD" tabindex="25" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM2_FRC_CLS_CD == (old('OVTM2_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM3_CD" tabindex="26" class="ovtCD"
                                                    ...
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM3_CD == (old('OVTM3_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM3_UNDER_MI" tabindex="27" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM3_UNDER_MI == (old('OVTM3_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM3_FRC_CLS_CD" tabindex="28" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM3_FRC_CLS_CD == (old('OVTM3_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM4_CD" tabindex="29" class="ovtCD"
                                                    ...
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM4_CD == (old('OVTM4_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM4_UNDER_MI" tabindex="30" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM4_UNDER_MI == (old('OVTM4_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM4_FRC_CLS_CD" tabindex="31" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM4_FRC_CLS_CD == (old('OVTM4_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM5_CD" tabindex="32" class="ovtCD"
                                                    ...
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM5_CD == (old('OVTM5_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM5_UNDER_MI" tabindex="33" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM5_UNDER_MI == (old('OVTM5_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM5_FRC_CLS_CD" tabindex="34" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM5_FRC_CLS_CD == (old('OVTM5_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="overTime">
                                            ...
                                            <td>
                                                <select name="OVTM6_CD" tabindex="35" class="ovtCD"
                                                    ...
                                                    <option value="<?php echo e($ovt_cd->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM6_CD == (old('OVTM6_CD',$ovt_cd->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM6_UNDER_MI" tabindex="36" class="ovtUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM6_UNDER_MI == (old('OVTM6_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="OVTM6_FRC_CLS_CD" tabindex="37" class="ovtFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->OVTM6_FRC_CLS_CD == (old('OVTM6_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="extraTime">
                                            ...
                                            <td>
                                                <select name="EXT1_CD" tabindex="38" class="extCD"
                                                    ...
                                                    <?php if(!isset($workptn_cd)): ?> disabled="disabled" <?php endif; ?>>
                                                    <option value=""></option>
                                                    <?php $__currentLoopData = $ext_datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ext_data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option value="<?php echo e($ext_data->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT1_CD == (old('EXT1_CD',$ext_data->WORK_DESC_CD)) ? 'selected' : ''); ?>

                                                        <?php endif; ?>>
                                                        <?php echo e($ext_data->WORK_DESC_NAME); ?>
                                            ...
                                            <td>
                                                <select name="EXT1_UNDER_MI" tabindex="39" class="extUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT1_UNDER_MI == (old('EXT1_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="EXT1_FRC_CLS_CD" tabindex="40" class="extFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT1_FRC_CLS_CD == (old('EXT1_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="extraTime">
                                            ...
                                            <td>
                                                <select name="EXT2_CD" tabindex="41" class="extCD"
                                                    ...
                                                    <option value="<?php echo e($ext_data->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT2_CD == (old('EXT2_CD',$ext_data->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="EXT2_UNDER_MI" tabindex="42" class="extUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT2_UNDER_MI == (old('EXT2_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="EXT2_FRC_CLS_CD" tabindex="43" class="extFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT2_FRC_CLS_CD == (old('EXT2_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                        ...
                                        <tr class="extraTime">
                                            ...
                                            <td>
                                                <select name="EXT3_CD" tabindex="44" class="extCD"
                                                    ...
                                                    <option value="<?php echo e($ext_data->WORK_DESC_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT3_CD == (old('EXT3_CD',$ext_data->WORK_DESC_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="EXT3_UNDER_MI" tabindex="45" class="extUnderMi"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_min->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT3_UNDER_MI == (old('EXT3_UNDER_MI',$cls_detail_min->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
                                            ...
                                            <td>
                                                <select name="EXT3_FRC_CLS_CD" tabindex="46" class="extFrcClsCd"
                                                    ...
                                                    <option value="<?php echo e($cls_detail_rf->CLS_DETAIL_CD); ?>"
                                                        <?php if(isset($search_fraction_data)): ?>
                                                        <?php echo e($search_fraction_data->EXT3_FRC_CLS_CD == (old('EXT3_FRC_CLS_CD',$cls_detail_rf->CLS_DETAIL_CD)) ? 'selected' : ''); ?>
...
<script>
    ...
    $(document).on('click', '.update', function() {
        ...
        .done((data, textStatus, jqXHR) => {
            location.href='<?php echo e(url('master/MT07FractionEditor')); ?>';
        })
...
<?php echo $__env->make('menu.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/master/MT07FractionEditor.blade.php ENDPATH**/ ?>