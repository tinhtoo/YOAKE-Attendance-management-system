...
<html lang="ja">
    ...
    <?php if(isset($wtPortraitDatas)): ?>
    <!-- 該当データがない場合 -->
    <?php if(count($wtPortraitDatas) < 1): ?>
    <body>
        <!-- ページ番号作成 -->
        ...
        <table class="workTable">
            <thead>
                ...
                <tr class="table-head2" style="width: 100%;">
                    ...
                    <th style="width: 60px; padding-right: 5px;">
                        <?php echo e(mb_substr($wt_data->WORK_DESC_NAME_200, 0, 4)); ?>
            ...
            <tbody>
                <tr style="width: 100%;">
                    ...
                    <td style="width:150px; text-align: left;"><?php echo e($w_time->WORKPTN_NAME); ?></td>
                    ...
                    <td><?php echo e($w_time->OUT2_TIME); ?></td>
                    <td><?php echo e($w_time->IN2_TIME); ?></td>
                    <td>
                        <?php echo e($w_time->WORK_TIME_HH .':'. substr('00'.$w_time->WORK_TIME_MI, -2)); ?>
                    ...
                    <td style="padding-right: 5px;">
                        <?php echo e($w_time->EXT1_TIME_HH .':'. substr('00'.$w_time->EXT1_TIME_MI, -2)); ?>
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <tr class="record-sum">
                    <td colspan="8"></td>
                    <td>社員計</td>
                    <td><?php echo e($sum_wt_hh . ':'. $sum_wt_mi); ?></td> <!-- 出勤時間 -->
                    <td><?php echo e($sum_tard_hh . ':' . $sum_tard_mi); ?></td> <!-- 遅刻時間 -->
                    <td><?php echo e($sum_leave_hh . ':' . $sum_leave_mi); ?></td> <!-- 早退時間 -->
                    <td><?php echo e($sum_out_hh . ':' . $sum_out_mi); ?></td> <!-- 外出時間 -->
                    <td><?php echo e($sum_ovtm1_hh . ':' . $sum_ovtm1_mi); ?></td> <!-- 残業項目１ -->
                    <td><?php echo e($sum_ovtm2_hh . ':' . $sum_ovtm2_mi); ?></td> <!-- 残業項目２ -->
                    <td><?php echo e($sum_ovtm3_hh . ':' . $sum_ovtm3_mi); ?></td> <!-- 残業項目３ -->
                    <td><?php echo e($sum_ovtm4_hh . ':' . $sum_ovtm4_mi); ?></td> <!-- 残業項目４ -->
                    <td style="padding-right: 5px;"><?php echo e($sum_ext1_hh . ':' . $sum_ext1_mi); ?></td> <!-- 割増対象１ -->
                </tr>
            </tbody>
        </table>    
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <?php endif; ?>
    <?php endif; ?>
</html><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/form_print/templates/WorktimePortraitPdf.blade.php ENDPATH**/ ?>