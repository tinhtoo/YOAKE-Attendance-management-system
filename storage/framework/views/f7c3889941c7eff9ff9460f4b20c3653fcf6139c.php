...
<html lang="ja">
    ...
    <!-- 該当データがない場合 -->
    <?php if(isset($wtLandscape2Datas)): ?>
    <?php if(count($wtLandscape2Datas) < 1): ?>
    <body>
        <!-- ページ番号作成 -->
    ...
    ?>
    <?php $__currentLoopData = $emp_worktime_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $emp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <body>
        <!-- ページ番号作成 -->
        <script type="text/php">
            if(isset($pdf)) {
        ...
        <div class="record">
            <span style="margin-left:20px;">部門</span>
            <span>:</span>
            <span><?php echo e($emp->DEPT_CD); ?></span>
            <span><?php echo e($emp->DEPT_NAME); ?></span>
        </div>
        <table class="workTable" style="width: 100%;">
            <thead>
                <tr class="table-head1" style="width: 100%;">
                    <th style="width:60px; padding-left: 5px; text-align: left;"><?php echo e($emp->EMP_CD); ?></th>
                    <th colspan="4" style="text-align: left;"><?php echo e($emp->EMP_NAME); ?></th>
                    <th style="width: 40px;">出勤:<?php echo e($emp->SUM_WORKDAY_CNT); ?></th>
                    <th style="width: 40px;">有休:<?php echo e($emp->SUM_PADHOL_CNT); ?></th>
                    <th style="width: 40px;">代休:<?php echo e($emp->SUM_COMPDAY_CNT); ?></th>
                    <th style="width: 40px;">特休:<?php echo e($emp->SUM_SPCHOL_CNT); ?></th>
                    <th style="width: 40px;">休出:<?php echo e($emp->SUM_HOLWORK_CNT); ?></th>
                    <th style="width: 40px;">欠勤:<?php echo e($emp->SUM_ABCWORK_CNT); ?></th>
                    <th style="width: 40px;">遅刻:<?php echo e($emp->SUM_TARD_CNT); ?></th>
                    <th style="width: 40px;">早退:<?php echo e($emp->SUM_LEAVE_CNT); ?></th>
                ...
                <tr class="table-head2" style="width: 100%;">
                    ...
                    <th style="width: 50px;">外出時間</th>
                    <th style="width: 50px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_100, 0, 4)); ?>

                    </th>
                    <th style="width: 50px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_101, 0, 4)); ?>

                    </th>
                    <th style="width: 50px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_102, 0, 4)); ?>

                    </th>
                    <th style="width: 50px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_103, 0, 4)); ?>

                    </th>
                    <th style="width: 50px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_104, 0, 4)); ?>

                    </th>
                    <th style="width: 50px; padding-right: 5px;">
                        <?php echo e(mb_substr($emp->WORK_DESC_NAME_105, 0, 4)); ?>
            ...
            <?php
                $emp_worktime_datas = $wtLandscape2Datas->where('DEPT_CD', $emp->DEPT_CD)
                                                       ...
                                                       ->unique('CALD_DATE');
            ?>
            <?php $__currentLoopData = $emp_worktime_datas->unique('CALD_DATE'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $w_time): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php
            ...
            <tbody>
                <tr style="width: 100%;">
                    ...
                    <td style="width:25px; text-align: left;"><?php echo e($w_time->REASON_NAME); ?></td>
                ...
                <tr class="record-sum">
                    ...
                    <td>社員計</td>
                    <td>
                        <?php if($emp_worktime_datas->whereNotNull('DEF_WORK_TIME_HH')->count()): ?>
                        <?php echo e($sum_def_hh . ':' . $sum_def_mi); ?>

                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($emp_worktime_datas->whereNotNull('HOL_WORK_TIME_HH')->count()): ?>
                        <?php echo e($sum_hol_hh . ':' . $sum_hol_mi); ?>

                        <?php endif; ?>
                    </td>
                    <td>
                        <?php if($emp_worktime_datas->whereNotNull('HOL_OUT_WORK_TIME_HH')->count()): ?>
    ...
    <?php endif; ?>
    <?php endif; ?>
</html><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/form_print/templates/WorktimeLandscape2Pdf.blade.php ENDPATH**/ ?>