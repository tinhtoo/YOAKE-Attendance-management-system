...
<?php $__env->startSection('title', '祝祭日・会社休日情報入力 '); ?>
                                ...
                                <?php echo csrf_field(); ?>
                                                    ...
                                                    <div>
                                                        <table tabindex="2" class="GridViewBorder" id="nationalHolidays"
                                                            ...
                                                            <tbody class="gvDept_2">
                                                                ...
                                                                <?php $__currentLoopData = $holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr class="rowNationalHolidays">
                                                                    <td>
                                                                        <select name="hld_month_holiday[<?php echo e($i); ?>][HLD_MONTH]" id="hld_month_holiday<?php echo e($i); ?>hld_month"
                                                                            class="hld_month_holiday" style="width: 45px;"
                                                                            onchange="AddDropDownList('year', 'hld_month_holiday<?php echo e($i); ?>hld_month', 'hld_day_holiday<?php echo e($i); ?>hld_day', true)"
                                                                            autofocus tabindex="3">
                                                                            <?php for($m = 1; $m <= 12; $m++): ?>
                                                                            <option value="<?php echo e($m); ?>"
                                                                                <?php echo e($m == (old('hld_month_holiday') ?? $holiday->HLD_MONTH) ? 'selected' : ''); ?>>
                                                                                <?php echo e($m); ?>
                                                                    ...
                                                                    <td>
                                                                        <select name="hld_day_holiday[<?php echo e($i); ?>][HLD_DAY]" id="hld_day_holiday<?php echo e($i); ?>hld_day" class="hld_day_holiday" style="width: 45px;" tabindex="3">
                                                                            <?php for($d = 1; $d <= 31; $d++): ?>
                                                                            <option value="<?php echo e($d); ?>"
                                                                            <?php echo e($d == (old('hld_day_holiday') ?? $holiday->HLD_DAY) ? 'selected' : ''); ?>>
                                                                            <?php echo e($d); ?>
                                                                    ...
                                                                    <td>
                                                                        <input type="search" name="hld_name_holiday[<?php echo e($i); ?>][HLD_NAME]"
                                                                            id="hld_name_holiday<?php echo e($i); ?>hld_name"  class="hld_name_holiday" maxlength="20"
                                                                            value="<?php echo e(old('hld_name_holiday') ?? $holiday->HLD_NAME); ?>"
                                                                            style="width: 170px;" onFocus="this.select()" tabindex="3"><br>
                                                                        <span class="text-danger" id="nationalHolidays<?php echo e($i); ?>nameNat"></span>
                                                                        <span class="text-danger" id="nationalHolidays<?php echo e($i); ?>"></span>
                                                                    </td>
                                                                    <td>
                                                                        <input type="button" name="dltBtn[<?php echo e($i); ?>][btnDelete]" style="width:75px;" class="deleteButtonRow" value="削除" tabindex="3">
                                                                    </td>
                                                                </tr>
                                                    ...
                                                    <div>
                                                        <table tabindex="5" class="GridViewBorder" id="companyHolidays"
                                                            ...
                                                            <tbody class="gvDept_3">
                                                                ...
                                                                <?php $__currentLoopData = $company_holidays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $company_holiday): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                                <tr class="rowCompanyHolidays">
                                                                    <td>
                                                                        <select name="hld_month_company_holiday[<?php echo e($i); ?>][HLD_MONTH]"
                                                                            id="hld_month_company_holiday<?php echo e($i); ?>hld_month" class="hld_month_company_holiday"
                                                                            onchange="AddDropDownList('year', 'hld_month_company_holiday<?php echo e($i); ?>hld_month', 'hld_day_company_holiday<?php echo e($i); ?>hld_day', true)"
                                                                            style="width: 45px;" tabindex="6">
                                                                            <?php for($m = 1; $m <= 12; $m++): ?>
                                                                            <option value="<?php echo e($m); ?>"
                                                                                <?php echo e($m == (old('hld_month_company_holiday') ?? $company_holiday->HLD_MONTH) ? 'selected' : ''); ?>>
                                                                                <?php echo e($m); ?>
                                                                    ...
                                                                    <td>
                                                                        <select name="hld_day_company_holiday[<?php echo e($i); ?>][HLD_DAY]" id="hld_day_company_holiday<?php echo e($i); ?>hld_day" class="hld_day_company_holiday" style="width: 45px;" tabindex="6">
                                                                            <?php for($d = 1; $d <= 31; $d++): ?>
                                                                            <option value="<?php echo e($d); ?>"
                                                                            <?php echo e($d == (old('hld_day_company_holiday') ?? $company_holiday->HLD_DAY) ? 'selected' : ''); ?>>
                                                                            <?php echo e($d); ?>
                                                                    ...
                                                                    <td>
                                                                        <input type="search" name="hld_name_company_holiday[<?php echo e($i); ?>][HLD_NAME]" id="hld_name_company_holiday<?php echo e($i); ?>hld_name" class="hld_name_company_holiday" maxlength="20"
                                                                            value="<?php echo e(old('hld_name_company_holiday') ?? $company_holiday->HLD_NAME); ?>"
                                                                            style="width: 170px;" onFocus="this.select()" tabindex="6"><br>
                                                                        <span class="text-danger" id="companyHolidays<?php echo e($i); ?>nameCom"></span>
                                                                        <span class="text-danger" id="companyHolidays<?php echo e($i); ?>"></span>
                                                                    </td>
                                                                    <td>
                                                                        <input type="button" name="dltBtn[<?php echo e($i); ?>][btnDelete]" style="width:75px;" class="deleteButtonRow" value="削除" tabindex="6">
                                                                    </td>
                                                                </tr>
                                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                            </tbody>
                                    ...
                                    <p class="ButtonField1">
                                        <input type="button" value="更新" name="btnUpdate" tabindex="7" id="btnUpdate"
                                            ...
                                            data-url="<?php echo e(url('master/MT08HolidayUpdate')); ?>"
                                            >
...
<?php echo $__env->make('menu.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/master/MT08HolidayEditor.blade.php ENDPATH**/ ?>