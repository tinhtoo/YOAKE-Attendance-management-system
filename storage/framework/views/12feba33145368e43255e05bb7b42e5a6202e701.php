...
<?php $__env->startSection('title', '勤務実績情報出力'); ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtStartTargetYear" tabindex="3"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtStartTargetYear"
                                            ...
                                            <select name="ctl00$cphContentsArea$ddlStartTargetMonth" tabindex="4"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_ddlStartTargetMonth"
                                                style="width: 50px;"
                                                onchange="AddDropDownList('ctl00_cphContentsArea_txtStartTargetYear', 'ctl00_cphContentsArea_ddlStartTargetMonth', 'ctl00_cphContentsArea_ddlStartTargetDay')">
                                            ...
                                            <select name="ctl00$cphContentsArea$ddlStartTargetDay" tabindex="5"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_ddlStartTargetDay"
                                                style="width: 50px;">
                                                <option selected="selected" value=""></option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtEndTargetYear" tabindex="6"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtEndTargetYear"
                                                style="width: 40px;" onfocus="this.select();"
                                            ...
                                            <select name="ctl00$cphContentsArea$ddlEndTargetMonth" tabindex="7"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_ddlEndTargetMonth"
                                                style="width: 50px;"
                                                onchange="AddDropDownList('ctl00_cphContentsArea_txtEndTargetYear', 'ctl00_cphContentsArea_ddlEndTargetMonth', 'ctl00_cphContentsArea_ddlEndTargetDay')">
                                                <option selected="selected" value=""></option>
                                                <option value="1">1</option>
                                            ...
                                            <select name="ctl00$cphContentsArea$ddlEndTargetDay" tabindex="8"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_ddlEndTargetDay"
                                                style="width: 50px;">
                                                <option selected="selected" value=""></option>
                                                <option value="1">1</option>
                                                <option value="2">2</option>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtStartDeptCd" tabindex="9"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtStartDeptCd"
                                                style="width: 50px;"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtEndDeptCd" tabindex="11"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtEndDeptCd"
                                                style="width: 50px;"
                                                onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;"
                                                onfocus="this.select();"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtStartEmpCd" tabindex="15"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtStartEmpCd"
                                                style="width: 80px;"
                                                onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;"
                                                onfocus="this.select();"
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="ctl00$cphContentsArea$txtEndEmpCd" tabindex="17"
                                                class="OutlineLabel" id="ctl00_cphContentsArea_txtEndEmpCd"
                                                style="width: 80px;"
                                                onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;"
                                                onfocus="this.select();"
...
<?php echo $__env->make('menu.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\06_SVN\resources\views/mng_oprt/WorkTimeExport.blade.php ENDPATH**/ ?>