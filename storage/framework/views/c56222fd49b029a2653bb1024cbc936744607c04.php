                            ...
                            <table class="InputFieldStyle1">
                                <tbody>
                                    <tr>
                                        <th>対象月度</th>
                                        <td>
                                            <select name="ddlTargetYear" id="ddlTargetYear" tabindex="1" class="ime" style="width: 70px;">
                                            ...
                                            <select name="ddlTargetMonth"  id="ddlTargetMonth" tabindex="2" class="ime">
                                                <?php for($m=1; $m<=12; $m++): ?> 
                                                <option 
                                                    value="<?php echo e($m); ?>" 
                                    ...
                                    <tr>
                                        <th>社員番号</th>
                                        <td>
                                            <!-- <input name="txtEmpCd" tabindex="3" name="emp_no" class="ime" id="txtEmpCd" style="width: 80px;" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;" onfocus="this.select();"  type="text" maxlength="10"> -->
                                            <input name="txtEmpCd" tabindex="3" class="ime" id="txtEmpCd" style="width: 80px;" type="text" maxlength="10" value="<?php echo e(old('txtEmpCd', !empty($search_data['txtEmpCd'])?$search_data['txtEmpCd']:'')); ?>">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        ...
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                <input name="txtOfcTime" class="ime" id="txtOfcTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OFC_TIME); ?>">
                                                                                                                                            </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblLevTime" style="width: 40px; display: inline-block;"><?php echo e($result->LEV_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtLevTime" class="ime" id="txtLevTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->LEV_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOut1Time" style="width: 40px; display: inline-block;"><?php echo e($result->OUT1_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtIn1Time" class="ime" id="txtIn1Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OUT1_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblIn1Time" style="width: 40px; display: inline-block;"><?php echo e($result->IN1_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtIn1Time" class="ime" id="txtIn1Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->IN1_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOut2Time" style="width: 40px; display: inline-block;"><?php echo e($result->OUT2_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOut2Time" class="ime" id="txtOut2Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OUT2_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblIn2Time" style="width: 40px; display: inline-block;"><?php echo e($result->IN2_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtIn2Time" class="ime" id="txtIn2Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->IN2_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblWorkTime" style="width: 40px; display: inline-block;"><?php echo e($result->WORK_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtWorkTime" class="ime" id="txtWorkTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->WORK_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblTardTime" style="width: 40px; display: inline-block;"><?php echo e($result->TARD_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtTardTime" class="ime" id="txtTardTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->TARD_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblLeaveTime" style="width: 40px; display: inline-block;"><?php echo e($result->LEAVE_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtLeaveTime" class="ime" id="txtLeaveTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->LEAVE_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOutTime" style="width: 40px; display: inline-block;"><?php echo e($result->OUT_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOutTime" class="ime" id="txtOutTime" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OUT_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOvtm1Time" style="width: 40px; display: inline-block;"><?php echo e($result->OVTM1_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm1Time" class="ime" id="txtOvtm1Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM1_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        ...
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm2Time" class="ime" id="txtOvtm2Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM2_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        ...
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm3Time" class="ime" id="txtOvtm3Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM3_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOvtm4Time" style="width: 40px; display: inline-block;"><?php echo e($result->OVTM4_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm4Time" class="ime" id="txtOvtm4Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM4_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOvtm5Time" style="width: 40px; display: inline-block;"><?php echo e($result->OVTM5_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm5Time" class="ime" id="txtOvtm5Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM5_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblOvtm6Time" style="width: 40px; display: inline-block;"><?php echo e($result->OVTM6_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtOvtm6Time" class="ime" id="txtOvtm6Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->OVTM6_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblExt1Time" style="width: 40px; display: inline-block;"><?php echo e($result->EXT1_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtExt1Time" class="ime" id="txtExt1Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->EXT1_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblExt2Time" style="width: 40px; display: inline-block;"><?php echo e($result->EXT2_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtExt2Time" class="ime" id="txtExt2Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->EXT2_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" style="white-space: nowrap;">
                                                                        <span id="lblExt3Time" style="width: 40px; display: inline-block;"><?php echo e($result->EXT3_TIME); ?></span>
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtExt3Time" class="ime" id="txtExt3Time" style="width: 40px;" type="text" maxlength="5" value="<?php echo e($result->EXT3_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                    <td id="b" class="GridViewRowLeft" style="white-space: nowrap;">
                                                                        ...
                                                                        <!-- <td id="a" style="display: none;">
                                                                                                                                                    <input name="txtRemark" class="ime" id="txtRemark" style="width: 250px;" type="text" maxlength="" value="<?php echo e($result->RSV1_TIME); ?>">
                                                                                                                                                </td> -->
                                                                    </td>
                                                                </tr>
                                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<script>
    ...
    $(document).on('click', '#btnShow', function(){
        ...
        $('#btnShow, #ddlTargetYear, #ddlTargetMonth, #txtEmpCd, #btnSearchEmpCd').attr('', true);
    });
</script>
