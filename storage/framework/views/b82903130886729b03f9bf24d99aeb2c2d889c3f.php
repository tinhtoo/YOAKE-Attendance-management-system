...
<html lang="ja">
    ...
    <body>
        ...
        <div class="record">
            ...
            <span>:</span>
            <span><?php echo e($target_date_str); ?></span><br>
        </div>
        <div class="record">
    ...
    ?>
    <?php $__currentLoopData = $time_stamp_datas->unique('DEPT_CD'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $time_stamp_in_dept): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    <?php 
    ...
    <body>
        ...
        <div class="date">
            <span>作表日：<?php echo e($now_date); ?></span>
        </div>
        <div class="header">
            <span>未打刻・二重打刻</span>
            <span>一覧表</span>
        ...
        <div class="record">
            <span style="margin-left:20px;">部門</span>
            <span>:</span>
            <span><?php echo e($time_stamp_in_dept['DEPT_CD']); ?></span>
            <span><?php echo e($time_stamp_in_dept['DEPT_NAME']); ?></span>
        </div>
        <table class="workTable" style="width: 100%;">
            <thead>
                <tr style="width: 100%;">
            ...
            <tbody>
                <?php $__currentLoopData = $time_stamp_array; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $time_stamp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                    ...
                    <?php for($record_num = 0; $record_num < $time_stamp_count; $record_num++): ?>
                    <?php
                    ...
                    ?>
                    <tr style="width: 100%;">
                        <td class="<?php echo e($border_bottom); ?>" style="text-align: center;">
                        <?php if($is_first_record_of_date): ?>
                        <?php echo e((($time_stamp['OFC_CNT'] >= 2 && !$time_stamp['OFC_TIME_HH']) || ($time_stamp['LEV_CNT'] >= 2 && !$time_stamp['LEV_TIME_HH'])
                        ...
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 5px;">
                            <?php echo e($view_emp_name ? $time_stamp['EMP_CD'] . '　　' . $time_stamp['EMP_NAME'] : ''); ?>

                        </td>
                        <td class="<?php echo e($border_bottom); ?>"><?php echo e($is_first_record_of_date ? $date . '('. $week[date("w", strtotime($time_stamp['CALD_DATE']))]. ')' : ''); ?></td>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;"><?php echo e($is_first_record_of_date ? $time_stamp['WORKPTN_NAME'] : ''); ?></td>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;"><?php echo e($is_first_record_of_date ? $time_stamp['REASON_NAME'] : ''); ?></td>
 
                        <?php if(isset($input_datas['chkNoTime'])): ?>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(count($ofc_time_records) === 0 && $record_num === 0): ?>
                            未打刻
                            <?php elseif(key_exists($record_num, $ofc_time_records)): ?>
                            <?php echo e($ofc_time_records[$record_num]); ?>

                            <?php endif; ?>
                        </td>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(count($lev_time_records) === 0 && $record_num === 0): ?>
                            未打刻
                            <?php elseif(key_exists($record_num, $lev_time_records)): ?>
                            <?php echo e($lev_time_records[$record_num]); ?>

                            <?php endif; ?>
                        </td>
                        <?php else: ?>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(key_exists($record_num, $ofc_time_records)): ?>
                            <?php echo e($ofc_time_records[$record_num]); ?>

                            <?php endif; ?>
                        </td>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(key_exists($record_num, $lev_time_records)): ?>
                            <?php echo e($lev_time_records[$record_num]); ?>
                        ...
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(key_exists($record_num, $in_time_records)): ?>
                            <?php echo e($in_time_records[$record_num]); ?>

                            <?php endif; ?>
                        </td>
                        <td class="<?php echo e($border_bottom); ?>" style="padding-left: 3px;text-align:right">
                            <?php if(key_exists($record_num, $out_time_records)): ?>
                            <?php echo e($out_time_records[$record_num]); ?>

                            <?php endif; ?>
                        </td>
                    </tr>

                    <?php if($record_count % $MAX_RECORD_NUM_IN_PAGE === 0): ?>
                    <?php
                    $record_count = 0;
                    ?>
                </tbody>
