...
class WorkTimePrintRequest extends BaseRequest
{
        ...
        if ($check == 'rbMonthCls') {
            $rules = [
                ...
                'filter.txtEndDeptCd' => ['nullable'
                                        ,parent::existDeptCdWithAuth('01', true)
                                        ,parent::startEndCheck('txtStartDeptCd', 'txtEndDeptCd')],
                'filter.ddlStartCompany' => ['nullable'
                                            ,parent::startEndCheck('ddlStartCompany', 'ddlEndCompany')],
                'filter.ddlEndCompany' => ['nullable'
                                            ,parent::startEndCheck('ddlStartCompany', 'ddlEndCompany')],
