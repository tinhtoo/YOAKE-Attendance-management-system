            ...
            $rules = [
                'filter.txtDeptCd' => [
                    ...
                    function($attribute, $value, $fail){
                        ...
                        //dd($emp_cd);
                        session()->put('emp_cd',$emp_cd);

                        //** ログイン社員の所属部門取得（A-2） */
                        $dept_cd = MT10Emp::where('MT10_EMP.EMP_CD', '=', $emp_cd)
                            ->pluck('DEPT_CD')->first();
                        //dd($dept_cd);
                        
                        //** ログイン社員の部門権限取得（A-3） */
                        $dept_auth_cd = MT10Emp::where('MT10_EMP.EMP_CD', '=', $emp_cd)
                        ...
                        $dept_auth = MT13DeptAuth::leftjoin('MT12_DEPT', 'MT13_DEPT_AUTH.DEPT_CD', '=', 'MT12_DEPT.DEPT_CD')
                            ...
                            ->where('MT13_DEPT_AUTH.DEPT_AUTH_CD', $dept_auth_cd) 
