    ...
    <table class="BaseContainerStyle1">
        <tbody>
            <tr>
                <td>
                    <div id="UpdatePanel1">
                        <form method="GET" action="{{ route('MT10EmpRef.search') }}">
                            {{ csrf_field() }}
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="filter[txtEmpCd]" style="width: 80px;"
                                                ...
                                                value="{{ old('txtEmpCd', isset($search_data) && key_exists('txtEmpCd', $search_data) ? $search_data['txtEmpCd'] : '') }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>社員カナ名</th>
                                        <td>
                                            ...
                                            value="{{ old('txtEmpKana', isset($search_data) && key_exists('txtEmpKana', $search_data) ? $search_data['txtEmpKana'] : '') }}">
                                        </td>
                                    </tr>
                                    <tr>
                                        <th>部門</th>
                                        <td>
                                            <input name="filter[txtDeptCd]" id="txtDeptCd" style="width: 50px;" class="searchDeptCd txtDeptCd"
                                                ...
                                                value="{{ old('filter[txtDeptCd]', isset($search_data) && key_exists('txtDeptCd', $search_data) ? $search_data['txtDeptCd']:'') }}"
                                                oninput="value = onlyHalfWord(value)"
                                            >
                                ...
                                <div>
                                    <table tabindex="7" class="GridViewSpace" id="gvEmp"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td class="col-sm-4">
                                                    <a href="{{ url('master/MT10EmpEditor/'. $search_results[$i]->EMP_CD )}}">
                                                        {{ $search_results[$i]->EMP_CD }} : {{ $search_results[$i]->EMP_NAME }}
                                                    </a>
                                                </td>
                                                <td class="col-sm-4">
                                                    @if($search_results[$i + 20] != null )
                                                    <a href="{{ url('master/MT10EmpEditor/'. $search_results[$i + 20]->EMP_CD )}}">
