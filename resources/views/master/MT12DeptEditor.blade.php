                                        ...
                                        <tr>
                                            ...
                                            <td class="deptHead">
                                                <input type="text "name="txtUpDeptCd" class="txtUpDeptCd"
                                                        ...
                                                        style="width: 50px;" maxlength="6" value="{{ old('txtUpDeptCd') ?? $dept_data->DEPT_CD }}"
                                                        ...
                                                        >
                                                        @if(isset($dept_data->DEPT_CD ))
                                                        <input type="hidden" name="txtUpDeptCd" class="txtUpDeptCd" value={{ $dept_data->DEPT_CD }}>
                                                        <input type="hidden" name="deptLevelNo" class="deptLevelNo" value={{ $dept_data->LEVEL_NO }}>
                                                        @endif
                                                ...
                                                <input type="search" name="txtUpDeptName" class="txtUpDeptName" tabindex="1"
                                                        ...
                                                        maxlength="20" value="{{ old('txtUpDeptName') ??$dept_data ->DEPT_NAME }}"
                                    ...
                                    <div class="GridViewPanelStyle7" >
                                        <table id="tbl" tabindex="3" style="border-collapse: collapse;" border="1" rules="all" cellspacing="0" >
                                            <tbody>
                                                ...
                                                @foreach ($dept_lists as $i => $dept_list)
                                                <tr class="rowDeptList">
                                                    <td>
                                                        <input type="text" style="width: 55px;" name="deptCd[{{ $i }}][DEPT_CD]" id="deptDataCd{{ $i }}deptCd"
                                                            maxlength="6" tabindex="4" class="deptCd imeDisabled" onfocus="this.select();"
                                                            value="{{$dept_list->DEPT_CD }}"
                                                            @if(isset($dept_list->DEPT_CD))
                                                            disabled
                                                            @endif
                                                            />
                                                            <input type="hidden" class="deptCd imeDisabled" name="deptCd[{{ $i }}][DEPT_CD]" value={{ $dept_list->DEPT_CD }}>
                                                    </td>
                                                    <td style="text-align:center">
                                                        <input type="search" style="width: 270px;" name="deptName[{{ $i }}][DEPT_NAME]"
                                                            maxlength="20" tabindex="4" class="deptName imeOn" onfocus="this.select();"
                                                            value="{{ $dept_list ->DEPT_NAME }}"
                                                            @if(isset($dept_list ->DEPT_NAME ))
                                                            onFocus="this.select()"
                                                            @endif
                                                            />
                                                            <br/>
                                                            <span class="deptCd text-danger" id="deptData{{ $i }}deptCd"></span>
                                                            <span class="deptName text-danger" id="deptData{{ $i }}deptName"></span>
                                                            <span class="text-danger" id="delRowCdData{{ $i }}deptCdRow"></span>
                                                            <span class="delOneRow text-danger" id="delOneRowCdData"></span>
                                                    </td>
                                                    <td>
                                                        <input type="button" tabindex="4" data-url="{{ url('master/MT12DeptDelRow') }}" name="dltBtn[{{ $i }}][btnDelete]" style="width:75px;" class="deleteButtonRow datacheck" value="削除">
                                                    </td>
                                                </tr>
                                                @endforeach
