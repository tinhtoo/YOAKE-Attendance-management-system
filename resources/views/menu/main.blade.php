        ...
        <tr>
            ...
            <td id="menu">
                <div class="sidenav">
                    ...
                    <div class="WorkTmMngMenuThird">
                        <a href="{{url('/WT_Print')}}">勤務予定表(週・月別)</a>
                        <a href="{{url('/WP_Print')}}">勤務実績表(日・週・月別)</a>
                        <a href="{{url('/TS_Print')}}">未打刻／二重打刻一覧表</a>
                        <a href="{{url('/RW_Print')}}">事由／勤怠一覧表</a>
                        <a href="{{url('/OT_Print')}}">残業申請書</a>
                    </div>
                    <button class="dropdown-btn WorkTmMngMenuSecond">シフト管理<i class="fa fa-caret-down"></i></button>
                    <div class="WorkTmMngMenuThird">
                        <a href="{{url('/ShiftPtn_Editor')}}">シフトパターン情報入力</a>
                        <a href="{{url('/MonthShift_Editor')}}">月別シフト入力</a>
                        <a href="{{url('/MonthShiftEmp_Editor')}}">社員別月別シフト入力</a>
                    </div>
                    ...
                    <div class="WorkTmMngMenuThird">
                        ...
                        <a href="#">組織変更入力</a>
                        <a href="#">部門権限情報入力</a>
                        <a href="#">祝祭日・会社休日情報入力</a>
                        <a href="#">勤務体系情報入力</a>
                        <a href="#">端数処理情報入力</a>
                        <a href="#">カレンダーパターン情報入力</a>
                        <a href="#">残業上限情報入力</a>
                        <a href="#">基本情報入力</a>
                        <a href="#">社員番号一括変換</a>
                        <a href="#">社員情報書出処理</a>
