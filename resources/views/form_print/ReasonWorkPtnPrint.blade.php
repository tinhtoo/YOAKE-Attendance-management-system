                        ...
                        <div id="ctl00_cphContentsArea_UpdatePanel1">
                                        ...
                                        <td>
                                            <div class="GroupBox1">
                                                <input name="ctl00$cphContentsArea$ReportCategory" tabindex="1"
                                                    id="ctl00_cphContentsArea_rbReason" type="radio" checked="checked"
                                                    value="rbReason"><label for="ctl00_cphContentsArea_rbReason">事由</label>
                                                <input name="ctl00$cphContentsArea$ReportCategory" tabindex="2"
                                                    id="ctl00_cphContentsArea_rbWorkPtn" type="radio"
                                                    value="rbWorkPtn"><label
                                                    for="ctl00_cphContentsArea_rbWorkPtn">勤怠</label>
                            ...
                            <table>
                                <tbody>
                                    <tr>
                                        <td>
                                            <input name="ctl00$cphContentsArea$chkRegCls" tabindex="21"
                            ...
                            <p class="ButtonField1">
                                <input name="ctl00$cphContentsArea$btnPrint" tabindex="22"
                                ...
                                <input name="ctl00$cphContentsArea$btnCancel" tabindex="23"
