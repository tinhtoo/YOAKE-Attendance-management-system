                ...
                <td>
                    <div id="ctl00_cphContentsArea_UpdatePanel1">
                        ...
                        <table class="InputFieldStyle1">
                            <tbody>
                                ...
                                <tr>
                                    <th>社員番号</th>
                                    <td>
                                        <input name="ctl00$cphContentsArea$txtEmpCd" tabindex="8" class="imeDisabled" id="ctl00_cphContentsArea_txtEmpCd" style="width: 80px;" onkeypress="if (WebForm_TextBoxKeyHandler(event) == false) return false;" onfocus="this.select();" onchange="javascript:setTimeout('__doPostBack(\'ctl00$cphContentsArea$txtEmpCd\',\'\')', 0)" type="text" maxlength="10">
                                        <input name="ctl00$cphContentsArea$btnSearchEmpCd" tabindex="9" class="SearchButton" id="ctl00_cphContentsArea_btnSearchEmpCd" onclick="SetEmpItem();__doPostBack('ctl00$cphContentsArea$btnSearchEmpCd','')" type="button" value="?">
                                        <span class="OutlineLabel" id="ctl00_cphContentsArea_lblEmpName" style="width: 200px; height: 17px; display: inline-block;"></span>
                                    </td>
                                </tr>
                            </tbody>
                        ...
                        <div class="mg10" style="text-align:left;border-bottom: 4px solid #fff;">
                            <input tabindex="10" id="btnSelectAll" onclick="ChangeAllCheckBoxStates(true)" type="button" value="全選択">
                            <input tabindex="11" id="btnNotSelectAll" onclick="ChangeAllCheckBoxStates(false)" type="button" value="全解除">
                        </div>
                        <table>
                            <tbody>
                                <tr>
                                    <td>
                                        <table class="GroupBox3">
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <input name="ctl00$cphContentsArea$ckWorkd" tabindex="12" id="ctl00_cphContentsArea_ckWorkd" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckWorkd">通常</label>
                                                        <input name="ctl00$cphContentsArea$ckPadh" tabindex="13" id="ctl00_cphContentsArea_ckPadh" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckPadh">有休</label>
                                                        <input name="ctl00$cphContentsArea$ckPadbh" tabindex="14" id="ctl00_cphContentsArea_ckPadbh" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckPadbh">前休</label>
                                                        <input name="ctl00$cphContentsArea$ckPadah" tabindex="15" id="ctl00_cphContentsArea_ckPadah" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckPadah">後休</label>
                                                        <input name="ctl00$cphContentsArea$ckCompd" tabindex="16" id="ctl00_cphContentsArea_ckCompd" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckCompd">代休</label>
                                                        <input name="ctl00$cphContentsArea$ckCompbd" tabindex="17" id="ctl00_cphContentsArea_ckCompbd" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckCompbd">前代</label>
                                                        <input name="ctl00$cphContentsArea$ckCompad" tabindex="18" id="ctl00_cphContentsArea_ckCompad" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckCompad">後代</label>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input name="ctl00$cphContentsArea$ckSpch" tabindex="19" id="ctl00_cphContentsArea_ckSpch" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckSpch">特休</label>
                                                        <input name="ctl00$cphContentsArea$ckAbcd" tabindex="20" id="ctl00_cphContentsArea_ckAbcd" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckAbcd">欠勤</label>
                                                        <input name="ctl00$cphContentsArea$ckDirg" tabindex="21" id="ctl00_cphContentsArea_ckDirg" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckDirg">直行</label>
                                                        <input name="ctl00$cphContentsArea$ckDirr" tabindex="22" id="ctl00_cphContentsArea_ckDirr" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckDirr">直帰</label>
                                                        <input name="ctl00$cphContentsArea$ckDirqr" tabindex="23" id="ctl00_cphContentsArea_ckDirqr" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckDirqr">直直</label>
                                                        <input name="ctl00$cphContentsArea$ckBusj" tabindex="24" id="ctl00_cphContentsArea_ckBusj" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckBusj">出張</label>
                                                        <input name="ctl00$cphContentsArea$ckDelay" tabindex="25" id="ctl00_cphContentsArea_ckDelay" type="checkbox" checked="checked"><label for="ctl00_cphContentsArea_ckDelay">遅延</label>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
