                                                            ...
                                                            <tr>
                                                                ...
                                                                <td style="white-space: nowrap;">
                                                                    <input
                                                                        ...
                                                                        @endif
                                                                    >
                                                                    <span class="text-danger timeError calcGuard"></span>
                                                                </td>
                                                                <td style="white-space: nowrap;">
                                                                    <input
...
$(document).on('click', '.update', function() {
    ...
    if ($("#sizeError").text() || $("#timeFormatError").text()) {
        return false;
    }
    var url = $(this).data('url');
    $('#form').attr('action', url);
...
$(function() {
    ...
    $('#ddlDate').on('click', function(event){$(event.target).focusout().focus()});
    $('#ddlDate').on('input', function(event){$(event.target).datepicker('show')});
